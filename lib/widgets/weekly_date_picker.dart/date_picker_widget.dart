...
class _DatePickerState extends State<DatePicker> {
  ...
  Widget build(BuildContext context) {
   // _controller.animateTo((_currentDate??DateTime.now()).day *1.0*widget.width,    duration: const Duration(seconds:1),curve: Curves.easeInOutCubic);
    var _stOfWeek=DateUtility.getStartDayOfWeek(_currentDate??DateTime.now());
    _controller = ScrollController(initialScrollOffset: (_stOfWeek.day-1) *1.0*widget.width,keepScrollOffset: true);
    return Container(
